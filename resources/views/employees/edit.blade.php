@extends('layouts.buildapp' , ['class' => 'off-canvas-sidebar', 'category_name' => __('employee'), 'page_name' => __('edit_employee')])
...
<div class="container">
                 ...
                 <div class="widget-content widget-content-area br-6 mt-5">
                    <form action="{{ url('/employee/'.$employee->id.'/update') }}"  method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Name</label>
                                <input type="text" name="name" class="form-control" placeholder="Enter Name" value="{{$employee->name}}" required>
                                @error('name')
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" name="fname"  class="form-control" placeholder="Enter Father Name" value="{{$employee->fname}}" required>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>CNIC No</label>
                          <input type="number" name="cnic"  class="form-control" placeholder="Enter CNIC No" value="{{$employee->cnic}}" required>
                          @error('cnic')
                          <span style="color: red">{{ $message }}</span>
                          @enderror
                        </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="designation"  class="form-control" placeholder="Enter Designation" value="{{$employee->designation}}" required>
                          @error('designation')
                          <span style="color: red">{{ $message }}</span>
                          @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" name="contact" placeholder="Enter Contact No" value="{{$employee->contact}}" class="form-control" required>
                                @error('contact')
                                <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Address </label>
                                <textarea type="text" name="address" class="form-control" placeholder="Enter Address" required>{{$employee->address}}</textarea>
                                @error('address')
                                <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                          <div class="form-group">
                              <label>Salary</label>
                              <input type="number" name="salary" placeholder="Enter Salary" value="{{$employee->salary}}" class="form-control" required>
                              @error('salary')
                              <span style="color: red">{{ $message }}</span>
                              @enderror
                          </div>
