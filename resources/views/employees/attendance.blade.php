@extends('layouts.buildapp' , ['class' => 'off-canvas-sidebar', 'category_name' => __('employee'), 'page_name' => __('manage_employee_attendance')])
...
<div class="container">
                 ...
                 <div class="widget-content br-6 mt-5">
                    <div>
                      <form action={{ url('/manage/storeemployee_attendance') }} method="POST">
                        @csrf
                      <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                            ...
                            <tr>
                                ...
                                @endif --}}
                                 <td>
                                  ...
                                  <input type="text" name='attendance_statuses[]' value='Present' data-id={{$value->id}}  class='btn btn-success m-auto addbtn' style="background-color: #1abc9c !important " multiple readonly>
                                 </td>
                            </tr>
                            @endforeach
                            @else
                             <td colspan="6">No Data Available</td>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      " class="text-center">No Data Available</td>
                            @endif 
                        ...
                        <div class="mb-3 row">
                          ...
                          <div class="col-md-3 ">
                            <a href="javascript:void(0)" class="delete_option btn btn-primary">Save Attendance</a>
                          </div>
                        </div>
