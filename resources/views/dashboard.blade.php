@extends('layouts.buildapp' , ['class' => 'off-canvas-sidebar', 'category_name' => __('dashboard'), 'page_name' => __('dashboard_page')])
@section('page_title' ,$page_title)
@section('content')

        <!--  BEGIN CONTENT AREA  -->
        <div id="content" class="main-content">
            <h2>Ottoman Projects:</h2>
            <p>Here is Total Projects With Their Images</p>
            <img src="{{ asset('assets/img/logo.png') }}" style="height: 100%; width:100%"/>
             <marquee behavior="" direction=""><h3>Dashboard Under Construction</h3></marquee>
