@extends('layouts.buildapp' , ['class' => 'off-canvas-sidebar', 'category_name' => __('material'), 'page_name' => __('manage_material_order')])
                            ...
                            <div class="statbox widget box box-shadow">
                                <div class="widget-header">                                
                                        ...
                                        <div class="col-xl-9 col-md-9 col-sm-9 col-9">
                                            <h4>Manage Material Purchases</h4>
                                        </div>
                                        <div class="col-xl-3 col-md-3 col-sm-3 col-3">
                                           <a href="{{ url('/materialorder/create') }}" class="btn btn-primary">Add Material Order</a>
                                        </div>
                                        </div>                                                        
                                </div>
                    ...
                    <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        {{-- <td>{{ $value->supplierof->code}}</td> --}}
                                        <td>{{ $value->supplierof->name }}</td>
                                        <td>{{ $value->materialof->name }}</td>
                                        <td>{{ $value->price }}</td>
                                        <td>{{ $value->qty }}</td>
                                        <td>{{ $value->total }}</td>
                                        ...
                                        {{--<td><img src="{{ asset($value->image) }}" class="img-fluid" width="100" height="100"></td> --}}
                                         <td><a href="{{ url('/materialorder/'.$value->id.'/edit') }}"><i data-feather="edit"></i></a>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a class="btn text-primary" data-dismiss="modal"><i class="flaticon-cancel-12"></i>Cancel</a>
                <a href="{{ url('/materialorder/'.$value->id.'/delete') }}" class="btn btn-primary">Delete</a>
        </div>
      </div>
