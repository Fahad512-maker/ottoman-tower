@extends('layouts.buildapp' , ['class' => 'off-canvas-sidebar', 'category_name' => __('equity'), 'page_name' => __('create_partner')])
...
<div class="container">
                 ...
                 <div class="widget-content widget-content-area br-6 mt-5">
                    <form action="{{ url('/partner/'.$edit->id.'/update') }}"  method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" class="form-control" style="text-transform: capitalize" placeholder="Enter Name" value="{{$edit->name}}" required>
                                @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Partner Cnic No</label>
                                <input type="text" name="cnic"  class="form-control" placeholder="Enter CNIC No" value="{{$edit->cnic}}" required>
                                @error('cnic')
                                <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="contact" placeholder="Enter Contact No" value="{{$edit->contact}}" class="form-control" required>
                                @error('contact')
                                <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Address </label>
                                <input type="text" style="text-transform: capitalize" name="address" class="form-control" value="{{$edit->address}}" placeholder="Enter Address" required>
                                @error('address')
                                <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
