                 ...
                 <div class="widget-content widget-content-area br-6 mt-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="cnic"  class="form-control" placeholder="Enter CNIC No" value="{{old('cnic')}}" required>
                                @error('cnic')
                                <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Address </label>
                                <input type="text" style="text-transform: capitalize" name="address" class="form-control" value="{{old('address')}}" placeholder="Enter Address" required>
                                @error('address')
                                <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
