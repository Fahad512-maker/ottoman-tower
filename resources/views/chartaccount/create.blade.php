...
<div class="container">
                 ...
                 <div class="widget-content widget-content-area br-6 mt-5">
                    <form action="{{ url('/chartaccount/store') }}"  method="POST" enctype="multipart/form-data">
                        @csrf
                    <div class="row mt-2">
                        <div class="col-md-6 mt-1">
                            <div class="form-group">
                                ...
                                <select name="account_type_id" id="" class="form-control">
                                    <option selected hidden disabled>-- Select Account Type --</option>
                        ...
                        <div class="col-md-6 mt-1">
                          ...
                          <input type="text"  name="account_name" placeholder="Enter Account" value="{{old('account_name')}}" class="form-control">
                          @error('account_name')
                          <span style="color: red">{{ $message }}</span>
                          @enderror
                      </div>
