@extends('layouts.buildapp' , ['class' => 'off-canvas-sidebar', 'category_name' => __('equity'), 'page_name' => __('manage_equity')])
...
<div class="container">
                            ...
                            <div class="statbox widget box box-shadow">
                                <div class="widget-header">                                
                                        ...
                                        <div class="col-xl-3 col-md-3 col-sm-3 col-3">
                                           <a href="{{ url('/equity/create') }}" class="btn btn-primary">Add Equity</a>
                                        </div>
                                        </div>                                                        
                                </div>
                 ...
                 <div class="widget-content widget-content-area br-6 mt-5">
                  <div class="row">
                    ...
                    <div class="col-md-4"></div>
                    <div class="col-md-4">Total Equity: <p class="tamount"></p></div>
                  </div>
                    <table class="table table-hover non-hover equity_table" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Partner Name</th>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a class="btn text-primary" data-dismiss="modal"><i class="flaticon-cancel-12"></i>Cancel</a>
                <a href="{{ url('/equity/'.$value->id.'/delete') }}" class="btn btn-primary">Delete</a>
        </div>
      </div>
