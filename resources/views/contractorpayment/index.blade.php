@extends('layouts.buildapp' , ['class' => 'off-canvas-sidebar', 'category_name' => __('contractor'), 'page_name' => __('manage_contractorpayment')])
                            ...
                            <div class="statbox widget box box-shadow">
                                <div class="widget-header">                                
                                        ...
                                        <div class="col-xl-9 col-md-9 col-sm-9 col-9">
                                            <h4>Manage Contractor Payment</h4>
                                        </div>
                                        <div class="col-xl-3 col-md-3 col-sm-3 col-3">
                                           <a href="{{ url('/contractorpay/create') }}" class="btn btn-primary">Add Contractor Payments</a>
                                        </div>
                                        </div>                                                        
                                </div>
                      ...
                      <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                        <thead>
                            <tr>
                                ...
                                <th>Project</th> 
                                <th>Contractor Expense</th> 
                                <th>Contractor Paid</th> 
                                <th>Contractor Remaining</th> 
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                {{--<td><img src="{{ asset($value->image) }}" class="img-fluid" width="100" height="100"></td> --}}
                                 <td><a href="{{ url('/contractorpay/'.$value->id.'/edit') }}"><i data-feather="edit"></i></a>
                                   <a href="javascript:void(0)" class="delete_option" data-id="{{ $value->id }}"><i data-feather="trash"></i></a>
                                   <a href="{{ url('/contractorpay/'.$value->id.'/print') }}" target="_blank" class="badge badge-primary" >Print</a>

                                   {{-- <a href="{{ url('/contractor/'.$value->id.'/view') }}"><i data-feather="eye"></i></a> --}}
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a class="btn text-primary" data-dismiss="modal"><i class="flaticon-cancel-12"></i>Cancel</a>
                <a href="{{ url('/contractorpay/'.$value->id.'/delete') }}" class="btn btn-primary">Delete</a>
        </div>
      </div>
