@extends('layouts.buildapp' , ['class' => 'off-canvas-sidebar', 'category_name' => __('contractor'), 'page_name' => __('create_contractorpay')])
...
<div class="container">
                 ...
                 <div class="widget-content widget-content-area br-6 mt-5">
                    <form action="{{ url('/contractorpay/store') }}"  method="POST" enctype="multipart/form-data">
                        @csrf
                    <div class="row mt-2">
                        <div class="col-md-6 mt-1">
                            <div class="form-group">
                                ...
                                <select name="contractor_id" id="" class="form-control">
                                    <option selected hidden disabled>-- Select Contractor --</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-1">
                            ...
                            <input type="number" id="expense" name="expense" placeholder="Enter Expense" value="{{old('expense')}}" class="form-control">
                            @error('expense')
                            <span style="color: red">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mt-3">
                            ...
                            <input type="number" id="paid" name="paid" placeholder="Enter Paid Amount" value="{{old('paid')}}" class="form-control">
                            @error('paid')
                            <span style="color: red">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-6 mt-3">
                            ...
                            <input type="number" readonly id="remaining" name="remaining" value="{{old('remaining')}}" class="form-control">
                            @error('remaining')
                            <span style="color: red">{{ $message }}</span>
                            @enderror
                        </div>
