...
/* border: 2px solid lightgray; */
    ...
    <div class="wrapper">
        <div class="header">
            ...
            <div><strong class="text-info"><b>Contractor Invoice # :</b></strong><u><b>{{$pay->id}}</b></u></div>
        </div>
       <div class="wrapper2" >
           {{-- <div class="paid">Amount Paid : {{$pay->paid}} </div>
           ...
           <table class="table dt-responsive" style="margin-top:20px;">
            <tr class="text-justify bg-white">
                <th class="w-50" style="border-top: 1px solid black">Amount Paid : <span class="font-weight-normal"><b>{{$pay->paid}}</b></span></th>
            ...
            <tr class="text-justify bg-white">
                <th style="border-top: 1px solid black" colspan="3">Mode of Payments : <span class="font-weight-normal"><b>{{$pay->accountstype->account_name}}</b></span></th>
            </tr>
            <tr class="text-justify bg-white">
                <th class="">To : <span class="font-weight-normal"><b>{{$pay->contractorof->name}}</b></span></th>
                <th class="" colspan="2">CNIC : <span class="font-weight-normal"><b>{{$pay->contractorof->cnic}}</b></span></th>
            </tr>
           
            <tr class="text-justify bg-white">
                <th class="" colspan="3">Note : <span class="font-weight-normal"><b>{{$pay->description}}</b> </span><br><br><br><br><br><br></th>
            </tr>
            <tr class="text-justify bg-white">
