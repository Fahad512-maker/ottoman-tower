@extends('layouts.buildapp' , ['class' => 'off-canvas-sidebar', 'category_name' => __('project'), 'page_name' => __('edit_project')])
...
<div class="container">
                 ...
                 <div class="widget-content widget-content-area br-6 mt-5">
                    <form action="{{ url('/project/'.$project->id.'/update') }}"  method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="projectname"  class="form-control" placeholder="Enter Project Name" value="{{$project->projectname}}" required>
                                @error('projectname')
                        ...
                        <div class="col-md-6" >
                            ...
                            <input class="form-control-file" name="picture" id="picture" type="file" value="{{$project->picture}}">
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="startdate"  value="{{$project->startdate}}" class="form-control" required>
                                @error('startdate')
                                <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        @php
                            $pCode = unserialize($project->productcode); 
                            $pName = unserialize($project->productname); 
                            $pQty = unserialize($project->qty);   
                        @endphp
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                              <div class="form-group">
                                  <input type="text" name="productcode[]" placeholder="Product Code" value="{{ $item }}" class="form-control" required> 
                              </div>
                            </div>
                            <div class="col-md-4">
                              <div class="form-group">
                              <input type="text" name="productname[]" placeholder="Product Name" value="{{ $pName[$key] }}" class="form-control" required> 
                              </div>
                            </div>
                            <div class="col-md-3">
                              <div class="form-group">
                              <input type="text" name="qty[]" placeholder="Product Quantity" value="{{ $pQty[$key] }}" class="form-control" required> 
                              </div>
                          </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" readonly name="cost"  value="{{$project->cost}}" class="form-control" required>
                            @error('cost')
                            <span style="color: red">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="progress" id="" class="form-control">
                                ...
                                <option value="On Going" {{$project->progress == 'On Going' ? "selected" : ''}}>On Going</option>
                                    <option value="Finished"  {{$project->progress == 'Finished' ? "selected" : ''}}>Finished</option>
                                    <option value="Cancel"  {{$project->progress == 'Cancel' ? "selected" : ''}}>Cancel</option>
                            </select>
                            @error('progress')
                            <span style="color: red">{{ $message }}</span>
                            @enderror
