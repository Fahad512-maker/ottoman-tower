@extends('layouts.buildapp' , ['class' => 'off-canvas-sidebar', 'category_name' => __('trashbox'), 'page_name' => __('trash_contractor')])
                            ...
                            <div class="statbox widget box box-shadow">
                                <div class="widget-header">                                
                                        ...
                                        <div class="col-xl-9 col-md-9 col-sm-9 col-9">
                                            <h4>Deleted Contractors</h4>
                                        </div>
                                        {{-- <div class="col-xl-3 col-md-3 col-sm-3 col-3">
                                           <a href="{{ url('/contractor/create') }}" class="btn btn-primary">Add Contractor</a>
                                        </div> --}}
                                        </div>                                                        
                                </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        {{--<td><img src="{{ asset($value->image) }}" class="img-fluid" width="100" height="100"></td> --}}
                                         <td><a href="{{ url('/trashcontractor/'.$value->id.'/undo') }}"><i data-feather="rotate-ccw"></i></a>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a class="btn text-primary" data-dismiss="modal"><i class="flaticon-cancel-12"></i>Cancel</a>
                <a href="{{ url('/trashcontractor/'.$value->id.'/delete') }}" class="btn btn-primary">Delete</a>
        </div>
      </div>
