@extends('layouts.buildapp' , ['class' => 'off-canvas-sidebar', 'category_name' => __('trashbox'), 'page_name' => __('trashproject')])
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              @endif
                                 ...
                                 <td><a href="{{ url('/trashproject/'.$value->id.'/undo') }}"><i data-feather="rotate-ccw"></i></a>
...
<div class="modal fade" id="delete-{{$value->id}}" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
        <h5>Are you Sure to Delete Permanently ?</h5>
        </div>
        <div class="modal-footer">
          <a class="btn text-primary" data-dismiss="modal"><i class="flaticon-cancel-12"></i>Cancel</a>
                <a href="{{ url('/trashproject/'.$value->id.'/delete') }}" class="btn btn-primary">Delete</a>
        </div>
      </div>
