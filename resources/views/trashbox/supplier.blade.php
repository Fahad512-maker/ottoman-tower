@extends('layouts.buildapp' , ['class' => 'off-canvas-sidebar', 'category_name' => __('trashbox'), 'page_name' => __('trash_supplier')])
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $value->phone}}</td> 
                                         ...
                                         <td><a href="{{ url('/trashsupplier/'.$value->id.'/undo') }}"><i data-feather="rotate-ccw"></i></a>
                                           <a href="javascript:void(0)" class="delete_option" data-id="{{ $value->id }}"><i data-feather="trash"></i></a>
                                           {{-- <a href="{{ url('/supplier/'.$value->id.'/view') }}"><i data-feather="eye"></i></a> --}}
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a class="btn text-primary" data-dismiss="modal"><i class="flaticon-cancel-12"></i>Cancel</a>
                <a href="{{ url('/trashsupplier/'.$value->id.'/delete') }}" class="btn btn-primary">Delete</a>
        </div>
      </div>
