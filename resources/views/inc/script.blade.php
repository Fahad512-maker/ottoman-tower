...
<script>
    $(document).on("click",".addpro",function(){
        let html=`<div class="row">
                      ...
                      <div class="col-md-2"><a href="javascript:void(0)" class="btn btn-danger remove_option">Delete</a></div>
                  </div>`;
                  $(".showpro").append(html);
    });
</script>
...
<script type="text/javascript">
    $(document).ready(function(){
       ...
       var table = $('.equity_table').DataTable({
       processing: true,
       serverSide: true,
       responsive: true,
       autoWidth : true,
       ajax: {
         url: '{{ url('/manage/equity') }}',
       },
       columns: [
           {data: 'id', name: 'id'},
           {data: 'partner' , name: 'partner'},
           {data: 'partner_amount' , name: 'partner_amount'},
       ...
       footerCallback: function (row, data, start, end, display) {
            ...
            // Update footer
            $('.tamount').html('Rs.' + pageTotal + ' ( Rs.' + total + ' total)');
        },
       "bDestroy": true,
       dom: 'lBfrtip',
        buttons: [
...
@break;
@case('create_contractorpay')
<script>
    $('#expense').on('keyup',function(){
...
$('.project_id').on('change',function(){
        ...
        $.ajax({
        url: '{{ url('/supplierpay/get_data') }}',
        type: 'post',
        data: {supplier:supplier,project:project , _token : '{{ csrf_token() }}'},
        success: function (data) {
          $('#supplier_expanse').val(data);
          $('#supplier_remaining').val(data);
        }
    });
    });
    $('#supplier_paid').on('keyup',function(){
        
        var expanse = $('#supplier_expanse').val();
        var paid = $('#supplier_paid').val();
        $('#supplier_remaining').val(expanse-paid);
    });
...
<script>
    ...
    $(document).on('click','.addbtn',function(){
        ...
        $(this).attr('style','background: #e7515a !important');
            ...
            $(this).attr('style','background: #1abc9c !important');
        } 
        let id = $(this).attr('data-id');
        
        $.ajax({
        url: "{{ url('/manage/pushemployee_attendance') }}",
        type: 'post',
...
autoWidth : true,
ajax: {
url: "{{ url('/manage/employee_attendance') }}",
},
columns: [
{data: 'name', name: 'name'},
{data: 'date' , name: 'date'},
{data: 'attendance_statuses' , name: 'attendance_statuses', orderable:false, searchable:false},
...
$(document).on('change' , '.attdate' , function(){
...
<script>
     $('.applicant').on('change',function(){
        ...
        $.ajax({
            ...
            success: function (data) {
                $('.cnic').val(data.client.cnic);
                $('.sowo').val(data.client.sowo);
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
    ...
    $(document).on('click' , '.booking_option' , function(){
 ...
 <script>
    ...
    $('#advance').on('keyup',function(){
        $advance = $(this).val();
        $total = $('#total').val();
        $('#remaining').val($total - $advance);
    });
    $('#numinstallment').on('keyup',function(){
        $number = $(this).val();
        $remaining = $('#remaining').val();
        $('#installment').val($remaining / $number);
