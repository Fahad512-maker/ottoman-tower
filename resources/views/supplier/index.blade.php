@extends('layouts.buildapp' , ['class' => 'off-canvas-sidebar', 'category_name' => __('smaterial'), 'page_name' => __('manage_supplier')])
                            ...
                            <div class="statbox widget box box-shadow">
                                <div class="widget-header">                                
                                        ...
                                        <div class="col-xl-3 col-md-3 col-sm-3 col-3">
                                           <a href="{{ url('/supplier/create') }}" class="btn btn-primary">Add Supplier</a>
                                        </div>
                                        </div>                                                        
                                </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $value->phone}}</td>
                                         ...
                                         <td><a href="{{ url('/supplier/'.$value->id.'/edit') }}"><i data-feather="edit"></i></a>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a class="btn text-primary" data-dismiss="modal"><i class="flaticon-cancel-12"></i>Cancel</a>
                <a href="{{ url('/supplier/'.$value->id.'/delete') }}" class="btn btn-primary">Delete</a>
        </div>
      </div>
