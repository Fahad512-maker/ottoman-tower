@extends('layouts.buildapp' , ['class' => 'off-canvas-sidebar', 'category_name' => __('material'), 'page_name' => __('manage_purchases')])
                            ...
                            <div class="statbox widget box box-shadow">
                                <div class="widget-header">                                
                                        ...
                                        <div class="col-xl-3 col-md-3 col-sm-3 col-3">
                                           <a href="{{ url('/purchases/create') }}" class="btn btn-primary">Add Purchase Item</a>
                                        </div>
                                        </div>                                                        
                                </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                {{--<td><img src="{{ asset($value->image) }}" class="img-fluid" width="100" height="100"></td> --}}
                                 <td><a href="{{ url('/purchases/'.$value->id.'/edit') }}"><i data-feather="edit"></i></a>
                                   <a href="javascript:void(0)" class="delete_option" data-id="{{ $value->id }}"><i data-feather="trash"></i></a>
                                   {{-- <a href="{{ url('/purchase/'.$value->id.'/view') }}"><i data-feather="eye"></i></a> --}}
...
<div class="modal fade" id="delete-{{$value->id}}" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Delete Record Permanently !</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        ...
        <div class="modal-footer">
          <a class="btn text-primary" data-dismiss="modal"><i class="flaticon-cancel-12"></i>Cancel</a>
                <a href="{{ url('/purchases/'.$value->id.'/delete') }}" class="btn btn-primary">Delete</a>
        </div>
      </div>
