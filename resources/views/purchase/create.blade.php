                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" style="text-transform: capitalize" name="supplier_name" class="form-control" placeholder="Supplier Name" value="{{old('supplier_name')}}" required>
                                @error('supplier_name')
                        ...
                        <div class="col-md-6">
                            <div class="form-select">
                                ...
                                <input type="text" style="text-transform: capitalize" name="product_name" class="form-control" placeholder="Product Name" value="{{old('product_name')}}" required>
                                @error('product_name')
                                <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" style="text-transform: capitalize" name="qty" class="form-control" placeholder="Quantity" value="{{old('qty')}}" required>
                                @error('qty')
                                <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-select">
                                <label>Price</label>
                                <input type="number" id="price" style="text-transform: capitalize" name="price" class="form-control" placeholder="Price" value="{{old('price')}}" required>
                                @error('price')
                                <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" id="paid" style="text-transform: capitalize" name="paid" class="form-control" placeholder="Paid Amount" value="{{old('paid')}}" required>
                                @error('paid')
                                <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-select">
                                ...
                                <input type="number" id="remaining" readonly style="text-transform: capitalize" name="remaining" class="form-control" placeholder="Remaining" value="{{old('remaining')}}" required>
                                @error('remaining')
                                <span style="color: red">{{ $message }}</span>
                                @enderror
                            </div>
