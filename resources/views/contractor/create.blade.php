...
<div class="container">
                 ...
                 <div class="widget-content widget-content-area br-6 mt-5">
                    <form action="{{ url('/contractor/store') }}"  method="POST" enctype="multipart/form-data">
                        @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>Contractor Name</label>
                                <input type="text" name="name" placeholder="Enter Contractor Name" value="{{old('name')}}" class="form-control">
                                @error('name')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" name="cnic" placeholder="Enter CNIC Number" value="{{old('cnic')}}" class="form-control">
                            @error('cnic')
                                <span style="color: red">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="number" name="phone" placeholder="Enter Phone Number" value="{{old('phone')}}" class="form-control">
                            @error('phone')
                            <span style="color: red">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <textarea type="text" name="address" placeholder="Enter Address" value="{{old('address')}}" class="form-control"></textarea>
                            @error('address')
                            <span style="color: red">{{ $message }}</span>
                            @enderror
                        </div>
