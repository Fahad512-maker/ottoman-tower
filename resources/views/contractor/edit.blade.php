@extends('layouts.buildapp' , ['class' => 'off-canvas-sidebar', 'category_name' => __('contractor'), 'page_name' => __('create_contractor')])
...
<div class="container">
                 ...
                 <div class="widget-content widget-content-area br-6 mt-5">
                    <form action="{{ url('/contractor/'.$contractor->id.'/update') }}"  method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" placeholder="Enter Contractor Name" value="{{$contractor->name}}" class="form-control">
                                @error('name')
                        ...
                        <div class="col-md-6">
                            <label for="">Contractor CNIC</label>
                            <input type="number" name="cnic" placeholder="Enter CNIC Number" value="{{$contractor->cnic}}" class="form-control">
                            @error('cnic')
                                <span style="color: red">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <input type="number" name="phone" placeholder="Enter Phone Number" value="{{$contractor->phone}}" class="form-control">
                            @error('phone')
                            <span style="color: red">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <textarea type="text" name="address" placeholder="Enter Address" class="form-control">{{$contractor->address}}</textarea>
                            @error('address')
                            <span style="color: red">{{ $message }}</span>
                            @enderror
                        </div>
