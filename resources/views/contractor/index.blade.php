@extends('layouts.buildapp' , ['class' => 'off-canvas-sidebar', 'category_name' => __('contractor'), 'page_name' => __('manage_contractor')])
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        {{--<td><img src="{{ asset($value->image) }}" class="img-fluid" width="100" height="100"></td> --}}
                                         <td><a href="{{ url('/contractor/'.$value->id.'/edit') }}"><i data-feather="edit"></i></a>
      ...
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <a class="btn text-primary" data-dismiss="modal"><i class="flaticon-cancel-12"></i>Cancel</a>
                <a href="{{ url('/contractor/'.$value->id.'/delete') }}" class="btn btn-primary">Delete</a>
        </div>
      </div>
